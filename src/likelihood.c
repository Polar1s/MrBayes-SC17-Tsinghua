...
int CondLikeDown_NUC4_512 (TreeNode *p, int division, int chain)
{
    int             c, k;
    CLFlt           *pL, *pR, *tiPL, *tiPR;
    __m512          *clL, *clR, *clP;
    ...
    for (k=0; k<m->numRateCats; k++)
    {
        for (c=0; c<m->numVecChars; c++)
        {
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AA));
            m3 = _mm512_mul_ps (m1, clL[A]);
            m4 = _mm512_mul_ps (m2, clR[A]);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AC));
            m3 = _mm512_fmadd_ps (m1, clL[C], m3);
            m4 = _mm512_fmadd_ps (m2, clR[C], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AG));
            m3 = _mm512_fmadd_ps (m1, clL[G], m3);
            m4 = _mm512_fmadd_ps (m2, clR[G], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AT));
            m3 = _mm512_fmadd_ps (m1, clL[T], m3);
            m4 = _mm512_fmadd_ps (m2, clR[T], m4);
            
            *clP++ = _mm512_mul_ps (m3, m4);

            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CA));
            m3 = _mm512_mul_ps (m1, clL[A]);
            m4 = _mm512_mul_ps (m2, clR[A]);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CC));
            m3 = _mm512_fmadd_ps (m1, clL[C], m3);
            m4 = _mm512_fmadd_ps (m2, clR[C], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CG));
            m3 = _mm512_fmadd_ps (m1, clL[G], m3);
            m4 = _mm512_fmadd_ps (m2, clR[G], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CT));
            m3 = _mm512_fmadd_ps (m1, clL[T], m3);
            m4 = _mm512_fmadd_ps (m2, clR[T], m4);
            
            *clP++ = _mm512_mul_ps (m3, m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GA));
            m3 = _mm512_mul_ps (m1, clL[A]);
            m4 = _mm512_mul_ps (m2, clR[A]);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GC));
            m3 = _mm512_fmadd_ps (m1, clL[C], m3);
            m4 = _mm512_fmadd_ps (m2, clR[C], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GG));
            m3 = _mm512_fmadd_ps (m1, clL[G], m3);
            m4 = _mm512_fmadd_ps (m2, clR[G], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GT));
            m3 = _mm512_fmadd_ps (m1, clL[T], m3);
            m4 = _mm512_fmadd_ps (m2, clR[T], m4);
            
            *clP++ = _mm512_mul_ps (m3, m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TA));
            m3 = _mm512_mul_ps (m1, clL[A]);
            m4 = _mm512_mul_ps (m2, clR[A]);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TC));
            m3 = _mm512_fmadd_ps (m1, clL[C], m3);
            m4 = _mm512_fmadd_ps (m2, clR[C], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TG));
            m3 = _mm512_fmadd_ps (m1, clL[G], m3);
            m4 = _mm512_fmadd_ps (m2, clR[G], m4);
            
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TT));
            m3 = _mm512_fmadd_ps (m1, clL[T], m3);
            m4 = _mm512_fmadd_ps (m2, clR[T], m4);
...
/*----------------------------------------------------------------
 ...
 |       variation using AVX512 instructions
 |
 -----------------------------------------------------------------*/
int CondLikeRoot_NUC4_512 (TreeNode *p, int division, int chain)
{
    int             c, k;
    CLFlt           *pL, *pR, *pA, *tiPL, *tiPR, *tiPA;
    ...
    for (k=0; k<m->numRateCats; k++)
    {
        for (c=0; c<m->numVecChars; c++)
        {
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AA));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + AA));
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AC));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + AC));
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AG));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + AG));
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + AT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + AT));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + AT));
            ...
            *clP++ = _mm512_mul_ps (m4, m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CA));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + CA));
            m4 = _mm512_mul_ps (m1, clL[A]);
            m5 = _mm512_mul_ps (m2, clR[A]);
            m6 = _mm512_mul_ps (m3, clA[A]);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CC));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + CC));
            m4 = _mm512_fmadd_ps (m1, clL[C], m4);
            m5 = _mm512_fmadd_ps (m2, clR[C], m5);
            m6 = _mm512_fmadd_ps (m3, clA[C], m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CG));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + CG));
            m4 = _mm512_fmadd_ps (m1, clL[G], m4);
            m5 = _mm512_fmadd_ps (m2, clR[G], m5);
            m6 = _mm512_fmadd_ps (m3, clA[G], m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + CT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + CT));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + CT));
            m4 = _mm512_fmadd_ps (m1, clL[T], m4);
            m5 = _mm512_fmadd_ps (m2, clR[T], m5);
            m6 = _mm512_fmadd_ps (m3, clA[T], m6);
            ...
            *clP++ = _mm512_mul_ps (m4, m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GA));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + GA));
            m4 = _mm512_mul_ps (m1, clL[A]);
            m5 = _mm512_mul_ps (m2, clR[A]);
            m6 = _mm512_mul_ps (m3, clA[A]);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GC));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + GC));
            m4 = _mm512_fmadd_ps (m1, clL[C], m4);
            m5 = _mm512_fmadd_ps (m2, clR[C], m5);
            m6 = _mm512_fmadd_ps (m3, clA[C], m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GG));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + GG));
            m4 = _mm512_fmadd_ps (m1, clL[G], m4);
            m5 = _mm512_fmadd_ps (m2, clR[G], m5);
            m6 = _mm512_fmadd_ps (m3, clA[G], m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + GT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + GT));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + GT));
            m4 = _mm512_fmadd_ps (m1, clL[T], m4);
            m5 = _mm512_fmadd_ps (m2, clR[T], m5);
            m6 = _mm512_fmadd_ps (m3, clA[T], m6);
            ...
            *clP++ = _mm512_mul_ps (m4, m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TA));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TA));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + TA));
            m4 = _mm512_mul_ps (m1, clL[A]);
            m5 = _mm512_mul_ps (m2, clR[A]);
            m6 = _mm512_mul_ps (m3, clA[A]);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TC));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TC));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + TC));
            m4 = _mm512_fmadd_ps (m1, clL[C], m4);
            m5 = _mm512_fmadd_ps (m2, clR[C], m5);
            m6 = _mm512_fmadd_ps (m3, clA[C], m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TG));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TG));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + TG));
            m4 = _mm512_fmadd_ps (m1, clL[G], m4);
            m5 = _mm512_fmadd_ps (m2, clR[G], m5);
            m6 = _mm512_fmadd_ps (m3, clA[G], m6);
            ...
            m1 = _mm512_broadcastss_ps (*(__m128*)(tiPL + TT));
            m2 = _mm512_broadcastss_ps (*(__m128*)(tiPR + TT));
            m3 = _mm512_broadcastss_ps (*(__m128*)(tiPA + TT));
            m4 = _mm512_fmadd_ps (m1, clL[T], m4);
            m5 = _mm512_fmadd_ps (m2, clR[T], m5);
            m6 = _mm512_fmadd_ps (m3, clA[T], m6);
...
/*----------------------------------------------------------------
 ...
 |       variation using AVX512 code
 |
 -----------------------------------------------------------------*/
int CondLikeScaler_NUC4_512 (TreeNode *p, int division, int chain)
{
    int             c, k;
    CLFlt           *scP, *lnScaler;
    __m512          *clPtr, **clP, *scP_512, m1;
    ModelInfo       *m;
    ...
    //__m512 onev512 = _mm512_set1_ps (1.);
    /* rescale */
    for (c=0; c<m->numVecChars; c++)
    {
        ...
        //__m512 im1 = _mm512_div_ps(onev512, m1);
...
/*------------------------------------------------------------------
 |
 |   Likelihood_NUC4_512: 4by4 nucleotide models with or without rate
 |       variation using AVX512 code
 |
 -------------------------------------------------------------------*/
int Likelihood_NUC4_512 (TreeNode *p, int division, int chain, MrBFlt *lnL, int whichSitePats)
{
    int             c, k, hasPInvar;
    ...
    *lnL = 0.0;
    ...
    if (hasPInvar == YES)
    {
        for (c=0; c<m->numVecChars; c++)
        {
            ...
            _mm512_store_ps (lnLI_Vec, mLike);
            clInvar += 4;
